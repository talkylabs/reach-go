# Contributing to `reach-go`

We'd love for you to contribute to our source code and to make `reach-go`
...
Help us keep `reach-go` open and inclusive. Please be kind to and considerate
of other developers, as we all have the same goal: make `reach-go` as good as
it can be.

## <a name="question"></a> Got an API/Product Question or Problem?

If you have questions about how to use `reach-go`, please see our
...
help us by submitting [an issue][issue-link]. This helper library was generated by leveraging [OpenAPI Generator](https://openapi-generator.tech) and the specs located at [talkylabs/reach-oai](https://github.com/talkylabs/reach-oai/tree/main/spec). If the issue is in the spec, please submit an issue there.
...
* **Major Changes** that you wish to contribute to the project should be
  discussed first with `reach-go` contributors in an issue or pull request so
...
* **`reach-go` Version(s)** - is it a regression?
...
* Run the full `reach-go` test suite (aliased by `make test`), and ensure
  that all tests pass.
...
In GitHub, send a pull request to `reach-go:main`.
If we suggest changes, then:

* Make the required updates.
* Re-run the `reach-go` test suite to ensure tests are still passing.
...
[issue-link]: https://github.com/talkylabs/reach-go/issues/new
[github]: https://github.com/talkylabs/reach-go
