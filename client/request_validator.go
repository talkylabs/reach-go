...
// RequestValidator is used to verify the Reach Signature included with Reach requests to webhooks.
// This ensures the request is actually coming from Reach and helps with securing your webhooks.
...
// Validate can be used for Reach Signatures sent with webhooks configured for GET calls. It returns true
// if the computed signature matches the expectedSignature. Params are a map of string to string containing
// all the query params Reach added to the configured webhook URL.
...
// ValidateBody can be used for Reach Signatures sent with webhooks configured for POST calls. It returns true
