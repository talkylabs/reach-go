...
// PaginatedConfigurationItemList struct for PaginatedConfigurationItemList
type PaginatedConfigurationItemList struct {
	Page int `json:"page,omitempty"`
	PageSize int `json:"pageSize,omitempty"`
	TotalConfigurations int `json:"totalConfigurations,omitempty"`
