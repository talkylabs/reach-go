...
// PaginatedAuthenticationTrialItemList struct for PaginatedAuthenticationTrialItemList
type PaginatedAuthenticationTrialItemList struct {
	Page int `json:"page,omitempty"`
	PageSize int `json:"pageSize,omitempty"`
	TotalAuthenticationTrials int `json:"totalAuthenticationTrials,omitempty"`
	TotalPages int `json:"totalPages,omitempty"`
	OutOfPageRange bool `json:"outOfPageRange,omitempty"`
	AuthenticationTrials []AuthenticationTrialItem `json:"authenticationTrials,omitempty"`
}
