...
// PaginatedAuthenticationItemList struct for PaginatedAuthenticationItemList
type PaginatedAuthenticationItemList struct {
	Page int `json:"page,omitempty"`
	PageSize int `json:"pageSize,omitempty"`
	TotalAuthentications int `json:"totalAuthentications,omitempty"`
	TotalPages int `json:"totalPages,omitempty"`
	OutOfPageRange bool `json:"outOfPageRange,omitempty"`
	Authentications []AuthenticationItem `json:"authentications,omitempty"`
}
