...
// AuthenticationTrialItem struct for AuthenticationTrialItem
type AuthenticationTrialItem struct {
...
func (response *AuthenticationTrialItem) UnmarshalJSON(bytes []byte) (err error) {
	raw := struct {
		...
		ChannelInfo map[string]interface{} `json:"channelInfo"`
	}{}
