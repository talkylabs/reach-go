...
// AuthenticationTrialStatItem struct for AuthenticationTrialStatItem
type AuthenticationTrialStatItem struct {
...
func (response *AuthenticationTrialStatItem) UnmarshalJSON(bytes []byte) (err error) {
	...
	*response = AuthenticationTrialStatItem{
		AppletId: raw.AppletId,
		ApiVersion: raw.ApiVersion,
		TotalTrials: raw.TotalTrials,
		NumSuccessfulTrials: raw.NumSuccessfulTrials,
		NumUnsuccessfulTrials: raw.NumUnsuccessfulTrials,
	}

	responseSuccessRate, err := client.UnmarshalFloat32(&raw.SuccessRate)
	if err != nil {
		return err
	}
	response.SuccessRate = *responseSuccessRate
